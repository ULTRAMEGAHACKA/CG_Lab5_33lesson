...
public:
    ...
    bool Init()
    {
        ...
        m_pEffect->SetColor(0, Vector4f(1.0f, 0.1f, 0.5f, 0.0f));
        m_pEffect->SetColor(1, Vector4f(1.0f, 1.0f, 0.0f, 0.0f));
        m_pEffect->SetColor(2, Vector4f(1.0f, 0.9f, 0.9f, 0.0f));
        m_pEffect->SetColor(3, Vector4f(0.8f, 1.0f, 1.0f, 0.0f));
